...
SELECT PAYMENT_DATE AS _DATE FROM PAYMENT_INFO WHERE PAYMENT_COUNTER = 1;

UPDATE PAYMENT_INFO SET PAYMENT_DATE = '12-SEP-22' WHERE PAYMENT_ID = '1010001';
...
SELECT * FROM CUSTOMER_INFO WHERE NAME LIKE 'M%';
